...
function seedRepository(rootDir) {
  const files = {
    ...
    'specifications/foundations/test-first-delivery.feature': 'Feature: Delivery\n\nScenario: Green path\n  Given a slice\n  When we validate it\n  Then the contract passes\n',
    'docs/knowledge-base/README.md': '- engineering-foundations.md\n- delivery-pipeline.md\n- security-standards.md\n',
    'docs/knowledge-base/engineering-foundations.md': '# Engineering Foundations\n',
